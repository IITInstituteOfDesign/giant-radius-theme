...
<footer class="main-footer">
  ...
  <div class="container">
    <div class="row">
      <div class="my-col col-lg-4">
        <div class="id-copy">
          <figure>
            <img src="<?php echo get_template_directory_uri() ?>/assets/img/id-logo.svg" alt="Institute of Design">
          </figure>
          <p>
            <span>IIT Institute of Design (ID)</span>
            <span>Illinois Institute of Technology (IIT)</span>
      ...
      <div class="my-col col-lg-4">
        <h4 style="margin-top:10px" class="footer-title">Follow Us</h4>
        <div class="follow-us" style="margin-top:5px">
          <?php
        ...
        <a href="https://id.iit.edu/join-our-mailing-list/" class="custom-btn" style="margin-top:10px;margin-bottom:10px">Join our mailing list</a>
      </div>
      <div class="my-col col-lg-4">
        <!--- <div class="bauhaus-logo" style="margin-top:65px; height: 50px;">
          <a href="/new-bauhaus/" style="display: block; height: 100%;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/BH-100-years-of-bauhaus.svg" alt="100 Years of Bauhaus" style="max-height: 100%"/></a>
	</div>--->
        <a href="https://www.iit.edu/privacy" class="custom-btn" style="margin-top:10px;margin-bottom:10px">Privacy Policy</a>
      </div>
    </div>
  </div>
</footer>
