  ...
  */
  public function media_fields() {
    ...
    function form( $instance ) {
      ...
      ?>
      <section id="widget_featured_link_ctm_adm">
      <p>
  ...
  <script>
    jQuery(document).ready(function($){
      $('#widget_featured_link_ctm_adm .checkbox-controller').each(function( index, element ){
        if ($(this).is(":checked")) {
      ...
      $('#widget_featured_link_ctm_adm .checkbox-controller').on('change', function(){
        console.log('post');
        if ($(this).is(":checked")) {
          $(this).parent().parent().find('.tohide').show();
        }else{
